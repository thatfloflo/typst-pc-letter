...
- The readme not contains a "How do I ...?" section with examples for things users might want to know how to do without reading all the configuration options. More items can be added to this in the future.
